(function () {
  ...
  a.pointOnLine = function (a, b, c) {
    var h = d(a, b), i = e(a, b), j = c > 0 ? f[i] : g[i], k = Math.atan(h), l = Math.abs(c * Math.sin(k)) * j[1],
  ...
  var a = {android: navigator.userAgent.toLowerCase().indexOf("android") > -1}, b = function (a, b, c) {
      ...
      if (null == a.__taSmartClicks) {
        var g = function (b) {
          ...
          if (a.__tad && a.__tau && a.__tad[0] === a.__tau[0] && a.__tad[1] === a.__tau[1]) for (var c = 0; c < a.__taSmartClicks.length; c++) a.__taSmartClicks[c].apply(d(b), [b])
        };
    ...
    n = function (a, c) {
      return function (f, g, h, i) {
        if ("contextmenu" == g && r) k(f, g, h, i); else {
          if (null == f.__taTapHandler) {
            var j = f.__taTapHandler = {tap: [], dbltap: [], contextmenu: [], down: !1, taps: 0, downSelectors: []},
              l = function (d) {
                for (var e = d.srcElement || d.target, g = 0; g < j.downSelectors.length; g++) if (null == j.downSelectors[g] || b(e, j.downSelectors[g], f)) {
                ...
                if (j.down) {
                  ...
                  for (var g in m) {
                    var h = m[g];
                    if (h.touches === e && (1 === h.taps || h.taps === j.taps)) for (var i = 0; i < j[g].length; i++) (null == j[g][i][1] || b(c, j[g][i][1], f)) && j[g][i][0].apply(d(a), [a])
                  }
                }
              }, o = function () {
                j.down = !1
    ...
    }, q = "ontouchstart" in document.documentElement, r = "onmousedown" in document.documentElement,
    s = {mousedown: "touchstart", mouseup: "touchend", mousemove: "touchmove"}, t = function () {
      var a = -1;
      ...
      if (g(a, b, c), d.__tauid = c.__tauid, a.addEventListener) a.addEventListener(b, c, !1); else if (a.attachEvent) {
        var e = b + c.__tauid;
      ...
      null != d && E(a, function () {
        var e = c(this);
        if (h(e, b, d), null != d.__tauid) if (e.removeEventListener) e.removeEventListener(b, d, !1), q && s[b] && e.removeEventListener(s[b], d, !1); else if (this.detachEvent) {
          var f = b + d.__tauid;
  ...
  this.Mottle = function (b) {
    b = b || {};
    var d = b.clickThreshold || 150, e = b.dblClickThreshold || 350, f = new p, g = new n(d, e), h = b.smartClicks,
      i = function (a, b, d, e) {
        null != d && E(a, function () {
          var a = c(this);
    ...
    this.remove = function (a) {
      return E(a, function () {
        var a = c(this);
        if (a.__ta) for (var b in a.__ta) for (var d in a.__ta[b]) D(a, b, a.__ta[b][d]);
        a.parentNode && a.parentNode.removeChild(a)
      }), this
    }, this.on = function () {
      var a = arguments[0], b = 4 == arguments.length ? arguments[2] : null, c = arguments[1],
      ...
      var g = r && ("undefined" == typeof MouseEvent || null == e || e.constructor === MouseEvent),
        h = q && !r && s[d] ? s[d] : d, i = !(q && !r && s[d]), j = w(e), k = x(e), l = y(e);
      return E(b, function () {
        var b, m = c(this);
  ...
  var n = 0, o = function () {
    ...
    this.unbindContainer = function () {
      if (null != p && r.length > 0) for (var a = 0; a < r.length; a++) f.off(p, r[a][0], r[a][1])
    ...
    var s = null, t = !1, u = [], v = {}, w = {}, x = {}, y = {}, z = {}, A = {}, B = !1, C = [], D = !1, E = null,
      F = this.Defaults.Scope, G = null, H = 1, I = function () {
        return "" + H++
      }, J = function (a, b) {
        ...
        if (!q.headless) {
          ...
          if (g && q.isDragSupported(a, f) && !q.isAlreadyDraggable(a, f)) {
            ...
            h = q.extend({}, h);
            var i = q.dragEvents.drag, j = q.dragEvents.stop, k = q.dragEvents.start, l = f.getElement(a),
              m = f.getDragManager().getDragAncestor(l), n = {left: 0, top: 0}, o = n, p = !1;
            pb(e, a), h[k] = d.wrap(h[k], function () {
              ...
              for (var c = function (a) {
                K(a[0], a[1]), f.removeClass(a[0], "jsPlumb_dragged"), f.select({source: a[0]}).removeClass(f.elementDraggingClass + " " + f.sourceElementDraggingClass, !0), f.select({target: a[0]}).removeClass(f.elementDraggingClass + " " + f.targetElementDraggingClass, !0), f.getDragManager().dragEnded(a[0])
        ...
        return q.each(a, function (a) {
          var b = f.getAttribute(a, "id"), c = null == A[b] ? !1 : A[b];
    ...
    this.setConnectionBeingDragged = function (a) {
      ...
      c = c || {};
      var e = f.getElement(a), g = Y(e), h = q.animEvents.step, i = q.animEvents.complete;
    ...
    var Z = [{el: "source", elId: "sourceId", epDefs: "sourceEndpointDefinitions"}, {
      ...
      if (b.constructor == q.Endpoint) e = b, e.addConnection(a); else if (f = Y(b), g = this[h.epDefs][f], f === a[h.elId]) e = null; else if (g) {
        if (!g.enabled) return;
    ...
    this.unregisterEndpoint = function (a) {
      ...
      if (0 !== arguments.length) {
        var a = f.Defaults.ConnectionType || f.getDefaultConnectionType(), b = arguments[0].constructor == a,
          c = 2 == arguments.length ? b ? arguments[1] || {} : arguments[0] : arguments[0], d = c.fireEvent !== !1,
      ...
      var b = {endpoints: {}, connections: {}, endpointCount: 0, connectionCount: 0}, c = a.fireEvent !== !1,
        d = a.deleteAttachedObjects !== !1, e = function (c) {
          if (null != c && null == b.connections[c.id] && (a.dontUpdateHover || null == c._jsPlumb || c.setHover(!1), b.connections[c.id] = c, b.connectionCount++, d)) for (var e = 0; e < c.endpoints.length; e++) c.endpoints[e]._deleteOnDetach && g(c.endpoints[e])
        }, g = function (c) {
          if (null != c && null == b.endpoints[c.id] && (a.dontUpdateHover || null == c._jsPlumb || c.setHover(!1), b.endpoints[c.id] = c, b.endpointCount++, d)) for (var f = 0; f < c.connections.length; f++) {
      ...
      var c, d, e;
      if ("object" == typeof a && a.length) for (c = 0, d = a.length; d > c; c++) e = m(a[c]), e.el && M(e.el, !0, b, e.id); else e = m(a), e.el && M(e.el, !0, b, e.id);
      return f
    };
    ...
    }, pb = f.manage = function (a, b) {
      return x[a] || (x[a] = {el: b, endpoints: [], connections: []}, x[a].info = qb({elId: a, timestamp: E})), x[a]
    ...
    this.init = function () {
      ...
      if ("string" == typeof c) g = b(arguments[0], {
        elementId: e,
        jsPlumbInstance: f
      }); else if (d.isArray(c)) if (d.isArray(c[0]) || d.isString(c[0])) 2 == c.length && d.isObject(c[1]) ? d.isString(c[0]) ? (a = q.extend({
        elementId: e,
        jsPlumbInstance: f
      ...
      return new q.DynamicAnchor({anchors: a, selector: b, elementId: null, jsPlumbInstance: f})
    ...
    var sb = function (a, b, c, d, e) {
      ...
      var i = new l(b), j = b._jsPlumb.EndpointDropHandler({
        jsPlumb: f, enabled: function () {
          ...
          var b = f.select({target: a.id}).length, c = a.el[h];
          return c.maxConnections > 0 && b >= c.maxConnections
        }, element: a.el, elementId: a.id, isSource: e, isTarget: g, addClass: function (b) {
          f.addClass(a.el, b)
          ...
          if ((null == e || null == e._jsPlumb) && (e = f.addEndpoint(a.el, b), e._mtNew = !0), b.uniqueEndpoint && (d.endpoint = e), e._doNotDeleteOnDetach = !1, e._deleteOnDetach = !0, c.isDetachable() && e.initDraggable(), null != e.anchor.positionFinder) {
            var g = f.getUIPosition(arguments, f.getZoom()), i = f.getOffset(a.el), j = f.getSize(a.el),
    ...
    this.makeTarget = function (a, b, c) {
      ...
      for (var g = e.maxConnections || 1, h = e.onMaxConnections, i = function (a) {
        ...
        var j = q.dragEvents.stop, l = q.dragEvents.drag, m = q.extend({}, e.dragOptions || {}), n = m.drag, o = m.stop,
          p = null, r = !1;
        m.scope = m.scope || e.scope, m[l] = d.wrap(m[l], function () {
          ...
          if (o && o.apply(this, arguments), this.currentlyDragging = !1, null != p._jsPlumb) {
            var a = e.anchor || this.Defaults.Anchor, c = p.anchor, d = p.connections[0],
              g = this.makeAnchor(a, b, this), h = p.element;
            if (null != g.positionFinder) {
              var i = f.getOffset(h), j = this.getSize(h), k = {left: i.left + c.x * j[0], top: i.top + c.y * j[1]},
    ...
    var wb = function (a, b, c, e) {
      ...
      if (d.isString(b)) f[b].enabled = e ? !f[b].enabled : c; else if (b.length) for (var g = 0, h = b.length; h > g; g++) {
        var i = m(b[g]);
    ...
    this.repaint = function (a, b, c) {
      ...
      var d = function (a) {
        ...
        if (i) for (c.push(h), e = 0, g = i.length; g > e; e++) f.deleteEndpoint(i[e]);
  ...
  "undefined" != typeof window && (window.jsPlumb = q), q.getInstance = function (a) {
    ...
    if (null != a) if ("string" == typeof a) b(q.getElement(a)); else if (null != a.length) for (var c = 0; c < a.length; c++) b(q.getElement(a[c])); else b(a)
  ...
  var b = !!window.SVGAngle || document.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1"),
    c = function () {
      ...
      var d = o(a), e = d.split(/\s+/), f = function (a, b) {
        for (var c = 0; c < b.length; c++) if (a) -1 == jsPlumbUtil.indexOf(e, b[c]) && e.push(b[c]); else {
  ...
  jsPlumb.extend(jsPlumbInstance.prototype, {
    ...
    getOffset: function (a, b) {
      ...
      for (var c = this.getContainer(), d = {
        ...
        null != b && b !== document.body && (b.scrollTop > 0 || b.scrollLeft > 0) && (this.getStyle(a, "position"), d.left -= b.scrollLeft, d.top -= b.scrollTop)
  ...
  b.Endpoint = function (a) {
    ...
    this.bind("mouseover", function () {
      ...
      var f, g = function (a, c) {
        ...
        if (!j.Defaults.DoNotThrowErrors) throw{msg: "jsPlumb: unknown endpoint type '" + a + "'"}
      }, h = {
      ...
      if (!b || this.timestamp !== b) {
        var d = j.updateOffset({elId: this.elementId, timestamp: b}), e = a.offset ? a.offset.o : d.o;
        if (null != e) {
          var f = a.anchorPoint, g = a.connectorPaintStyle;
          if (null == f) {
            var i = a.dimensions || d.s, k = {xy: [e.left, e.top], wh: i, element: this, timestamp: b};
            if (c && this.anchor.isDynamic && this.connections.length > 0) {
              var l = h(this, a.elementWithPrecedence), m = l.endpoints[0] == this ? 1 : 0,
                n = 0 === m ? l.sourceId : l.targetId, o = j.getCachedData(n), p = o.o, q = o.s;
    ...
    this.initDraggable = function () {
      if (!p && b.isDragSupported(this.element)) {
        var g = {id: null, element: null}, h = null, i = !1, n = null, o = d(g, j), q = a.dragOptions || {}, r = {},
          s = b.dragEvents.start, t = b.dragEvents.stop, u = b.dragEvents.drag, v = function () {
            ...
            if (jsPlumb.setPosition(g.element, q), this.parentAnchor && (this.anchor = j.makeAnchor(this.parentAnchor, this.elementId, j)), j.setAttributes(this.canvas, {
              ...
              data: d
            }), h.addClass(j.draggingClass), this._jsPlumb.floatingEndpoint.addClass(j.draggingClass), j.fire("connectionDrag", h); else {
              i = !0, h.setHover(!1);
    ...
    var t = function (d, e, f, g, h) {
      if ((this.isTarget || e) && b.isDropSupported(this.element)) {
        ...
        i[k] = c.wrap(i[k], o, !0), i[l] = c.wrap(i[l], function () {
          var a = b.getDragObject(arguments), c = j.getAttribute(b.getElement(a), "dragId"),
          ...
          var a = b.getDragObject(arguments), c = null == a ? null : j.getAttribute(b.getElement(a), "dragId"),
    ...
    return function (b) {
      ...
      var d = c.getDropEvent(arguments), e = c.getDragObject(arguments), f = c.getAttribute(e, "dragId"),
        g = (c.getAttribute(e, "elId"), c.getAttribute(e, "originalScope")), h = c.floatingConnections[f];
      if (null != h && (!h.suspendedEndpoint || null != h.suspendedEndpoint._jsPlumb)) {
        ...
        if ((0 !== j || a.isSource) && (1 !== j || a.isTarget)) {
          if (a.onDrop && a.onDrop(h), g && c.setDragScope(e, g), a.isFull(b) && i.fire("maxConnections", {
            endpoint: this,
            connection: h,
  ...
  b.Connection = function (a) {
    ...
    applyType: function (a, c, d) {
      ...
      var e;
      if (null != this.connector && (e = this.connector, this.connector.cleanup(), this.connector.destroy()), this.connector = a, d && this.cacheTypeItem("connector", a, d), this.canvas = this.connector.canvas, this.bgCanvas = this.connector.bgCanvas, this.canvas && (this.canvas._jsPlumb = this), this.bgCanvas && (this.bgCanvas._jsPlumb = this), null != e) for (var f = this.getOverlays(), g = 0; g < f.length; g++) f[g].transfer && f[g].transfer(this.connector);
      ...
      if (!this._jsPlumb.instance.isSuspendDrawing() && this._jsPlumb.visible) {
        ...
        if (null == b || b != this._jsPlumb.lastPaintedAt) {
          ...
          var q = parseFloat(this._jsPlumb.paintStyleInUse.lineWidth || 1) / 2,
            r = parseFloat(this._jsPlumb.paintStyleInUse.lineWidth || 0), s = {
  ...
  c.AnchorManager = function (a) {
    var d = {}, e = {}, f = {}, g = {},
      ...
      i = ["left", "top", "right", "bottom"], j = {}, k = this, l = {}, m = a.jsPlumbInstance, n = {},
    ...
    this.updateOtherEndpoint = function (a, d, e, f) {
      ...
      if (!m.isSuspendDrawing()) {
        ...
        for (var t = m.updateOffset({elId: a, offset: e, recalc: !1, timestamp: f}), v = {}, x = 0; x < p.length; x++) {
          var y = p[x][0], z = y.sourceId, A = y.targetId, B = y.endpoints[0].anchor.isContinuous,
            C = y.endpoints[1].anchor.isContinuous;
          if (B || C) {
            var D = z + "_" + A, E = v[D], F = y.sourceId == a ? 1 : 0;
            B && !l[z] && (l[z] = {top: [], right: [], bottom: [], left: []}), C && !l[A] && (l[A] = {
              top: [],
              right: [],
              bottom: [],
              left: []
            }), a != A && m.updateOffset({elId: A, timestamp: f}), a != z && m.updateOffset({elId: z, timestamp: f});
        ...
        for (x = 0; x < k.length; x++) 0 === k[x].connections.length && k[x].anchor.isContinuous && (l[a] || (l[a] = {
          ...
          endpoints: [k[x], k[x]], paint: function () {
          }
        ...
        var L = n[a];
        for (L && L.paint({timestamp: f, recalc: !1, elId: a}), x = 0; x < q.length; x++) q[x].paint({
          elId: a,
          timestamp: f,
          recalc: !1,
          clearEdits: h
  ...
  b.Segments = {
    AbstractSegment: function (a) {
      ...
      this.pointOnPath = function (b, c) {
        ...
        var e = this.pointOnPath(b, d), f = 2 * (c / h) * Math.PI, g = this.anticlockwise ? -1 : 1, i = e.theta + g * f,
          j = a.cx + this.radius * Math.cos(i), k = a.cy + this.radius * Math.sin(i);
        return {x: j, y: k}
      }
    }, Bezier: function (c) {
      this.curve = [{x: c.x1, y: c.y1}, {x: c.cp1x, y: c.cp1y}, {x: c.cp2x, y: c.cp2y}, {
        x: c.x2,
        y: c.y2
  ...
  b.Connectors.AbstractConnector = function (a) {
    ...
    var f = [], g = 0, h = [], i = [], j = a.stub || 0, k = c.isArray(j) ? j[0] : j, l = c.isArray(j) ? j[1] : j,
      m = a.gap || 0, n = c.isArray(m) ? m[0] : m, o = c.isArray(m) ? m[1] : m, p = null, q = !1, r = null;
    ...
    var w = function (a) {
      ...
      var b = d.quadrant(a.sourcePos, a.targetPos), c = a.targetPos[0] < a.sourcePos[0],
        e = a.targetPos[1] < a.sourcePos[1], f = a.lineWidth || 1,
  ...
  h.prototype = {
    ...
    this.computeMaxSize = function () {
      ...
      if (a.pointAlongPathFrom) {
        ...
        var q = {hxy: h, tail: k, cxy: l}, r = e.strokeStyle || g.strokeStyle, s = e.fillStyle || g.strokeStyle,
    ...
    a = a || {};
    var c = a.length || 40, d = jsPlumb.extend(a, {length: c / 2, foldback: 2});
  ...
  c.extend(j, [b.jsPlumbUIComponent, h], {
    ...
    a.length = 50, a.lineWidth = 5, this.type = "GuideLines", h.apply(this, arguments), b.jsPlumbUIComponent.apply(this, arguments), this.draw = function (b) {
      var c = b.pointAlongPathFrom(a.loc, a.length / 2), e = b.pointOnPath(a.loc), f = d.pointOnLine(c, e, a.length),
        g = d.perpendicularLineTo(c, f, 40), h = d.perpendicularLineTo(f, c, 20);
      return {
        connector: b,
        head: c,
        tail: f,
  ...
  var a = this, b = a.jsPlumb, c = a.jsPlumbUtil, d = function (a) {
    ...
    var c, d, e = b.Connectors.AbstractConnector.apply(this, arguments), f = null == a.midpoint ? .5 : a.midpoint,
      g = a.alwaysRespectStubs === !0, h = null, i = null, j = null, k = null != a.cornerRadius ? a.cornerRadius : 0,
      l = function (a) {
        ...
        for (var d, f = null, g = 0; g < b.length - 1; g++) {
          if (f = f || o(b[g]), d = o(b[g + 1]), k > 0 && f[4] != d[4]) {
            ...
            var i = f[6] == d[5] && 1 == d[5] || f[6] == d[5] && 0 === d[5] && f[5] != d[6] || f[6] == d[5] && -1 == d[5],
              j = d[1] > f[3] ? 1 : -1, l = d[0] > f[2] ? 1 : -1, m = j == l, p = m && i || !m && !i ? d[0] : f[2],
              q = m && i || !m && !i ? f[3] : d[1];
            e.addSegment(a, "Straight", {x1: f[0], y1: f[1], x2: f[2], y2: f[3]}), e.addSegment(a, "Arc", {
              r: h,
              x1: f[2],
              y1: f[3],
              x2: d[0],
    ...
    this.setSegments = function (a) {
      ...
      var k = a.startStubX + (a.endStubX - a.startStubX) * f, l = a.startStubY + (a.endStubY - a.startStubY) * f,
        n = {x: [0, 1], y: [1, 0]}, o = function () {
          ...
          perpendicular: function (b) {
            var c = a, d = {
              ...
              }, f = {x: [[k, c.startStubY], [k, c.endStubY]], y: [[c.startStubX, l], [c.endStubX, l]]},
              ...
              }, j = {x: [c.startStubY, c.endStubY], y: [c.startStubX, c.endStubX]}, m = n[b][0], o = n[b][1],
              p = c.so[m] + 1, q = c.to[o] + 1,
              r = -1 == c.to[o] && j[b][1] < j[b][0] || 1 == c.to[o] && j[b][1] > j[b][0], s = e[b][p][0], t = e[b][p][1],
              u = d[b][p][q];
        ...
        }, s = q[a.anchorOrientation](a.sourceAxis), t = "x" == a.sourceAxis ? 0 : 1, u = "x" == a.sourceAxis ? 1 : 0,
        v = s[t], w = s[u], x = s[t + 2], y = s[u + 2];
      m(c, s[0], s[1], a);
      ...
      for (var b = 0; b < a.length; b++) {
        var c = a[b].start[0], d = a[b].start[1], e = a[b].end[0], f = a[b].end[1], g = c == e ? "v" : "h",
          i = l(e - c), j = l(f - d);
  ...
  var a = this, b = a.jsPlumb, c = a.jsPlumbUtil, d = function (a, b, c, d) {
    ...
    var c = b.Connectors.AbstractConnector.apply(this, arguments), f = a.curviness || 10, g = a.margin || 5,
      h = a.proximityLimit || 80, i = a.orientation && "clockwise" === a.orientation, j = a.loopbackRadius || 25,
      k = a.showLoopback !== !1;
    this._compute = function (a, b) {
      ...
      if (k && b.sourceEndpoint.elementId === b.targetEndpoint.elementId) {
        ...
        var v = b.sourcePos[0] < b.targetPos[0] ? 0 : l, w = b.sourcePos[1] < b.targetPos[1] ? 0 : m,
          x = b.sourcePos[0] < b.targetPos[0] ? l : 0, y = b.sourcePos[1] < b.targetPos[1] ? m : 0;
        ...
        var z = (v + x) / 2, A = (w + y) / 2, B = d(v, w, x, y), C = Math.sqrt(Math.pow(x - v, 2) + Math.pow(y - w, 2)),
  ...
  var a = this, b = a.jsPlumb, c = a.jsPlumbUtil, d = function (a) {
    ...
    this.type = "Bezier", this.getCurviness = function () {
      ...
      var d = b.sourcePos, e = b.targetPos, f = Math.abs(d[0] - e[0]), g = Math.abs(d[1] - e[1]),
  ...
  var a = this, b = a.jsPlumb, c = a.jsPlumbUtil, d = {
    ...
    k = "stop", l = "stroke", m = "stroke-width", n = "style", o = "none", p = "jsplumb_gradient_", q = "lineWidth",
    r = {svg: "http://www.w3.org/2000/svg", xhtml: "http://www.w3.org/1999/xhtml"}, s = function (a, b) {
  ...
  var a = this, b = a.jsPlumb, c = a.jsPlumbUtil,
    d = {"stroke-linejoin": "joinstyle", joinstyle: "joinstyle", endcap: "endcap", miterlimit: "miterlimit"}, e = null;
  ...
  var i = 1e3, j = function (a, b) {
    ...
    if (b.dashstyle) null == d.strokeNode ? d.strokeNode = k("stroke", [0, 0, 0, 0], {dashstyle: b.dashstyle}, a, e) : d.strokeNode.dashstyle = b.dashstyle; else if (b["stroke-dasharray"] && b.lineWidth) {
    ...
    b.jsPlumbUIComponent.apply(this, arguments), this.opacityNodes = {
      ...
      a.opacityNodes.stroke = k("stroke", [0, 0, 1, 1], {opacity: "0.0"}, b, a._jsPlumb.instance), a.opacityNodes.fill = k("fill", [0, 0, 1, 1], {opacity: "0.0"}, b, a._jsPlumb.instance)
  ...
  var q = b.ConnectorRenderers.vml = function (a, e) {
    ...
    this.paint = function (g) {
      if (null !== g) {
        ...
        if (g.outlineColor) {
          var q = g.outlineWidth || 1, r = g.lineWidth + 2 * q,
      ...
      getPath: function (a) {
        return {
          Straight: function (a) {
            ...
            var b = a.params, c = Math.min(b.x1, b.x2), d = (Math.max(b.x1, b.x2), Math.min(b.y1, b.y2)),
              e = (Math.max(b.y1, b.y2), a.anticlockwise ? 1 : 0), f = a.anticlockwise ? "at " : "wa ",
              g = function () {
    ...
    this.paint = function (a, f) {
      if (a.component.canvas && f) {
        ...
        var n = Math.min(h.hxy.x, h.tail[0].x, h.tail[1].x, h.cxy.x),
          ...
          q = Math.max(h.hxy.y, h.tail[0].y, h.tail[1].y, h.cxy.y), r = Math.abs(p - n), s = Math.abs(q - o),
          t = [n, o, r, s];
  ...
  "use strict";
  var c = b.jsPlumb, d = b.jsPlumbUtil, e = function (b) {
  ...
  a.extend(b.jsPlumbInstance.prototype, {
    ...
    initDraggable: function (b, e, f) {
      e = e || {}, b = a(b), e.start = d.wrap(e.start, function () {
        a("body").addClass(this.dragSelectClass)
      }, !1), e.stop = d.wrap(e.stop, function () {
        a("body").removeClass(this.dragSelectClass)
      }), e.doNotRemoveHelper || (e.helper = null), "internal" == f && (e.scope = e.scope || c.Defaults.Scope), b.draggable(e)
    },
    initDroppable: function (b, d) {
      d.scope = d.scope || c.Defaults.Scope, a(b).droppable(d)
    },
    ...
    getDragObject: function (a) {
      var b = a[1].helper || a[1].draggable;
      return b ? b[0] : null
    },
    ...
    setDragFilter: function (b, d) {
      c.isAlreadyDraggable(b) && a(b).draggable("option", "cancel", d)
    },
