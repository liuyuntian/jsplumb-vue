(function () {
  ...
  var a = {
    ...
    var c = 1, d = 0, e = a[b].x - a[0].x, f = a[b].y - a[0].y, g = a[0].x - 0, h = a[0].y - 0, i = e * d - f * c,
      j = 1 / i, k = (e * h - f * g) * j;
    return 0 + c * k
  ...
  var a = this, b = {android: navigator.userAgent.toLowerCase().indexOf("android") > -1}, c = function (a, b, c) {
      ...
      if (d) {
        if ("undefined" != typeof a.path && a.path.indexOf) return {path: a.path, end: a.path.indexOf(c)};
        ...
        var n = function (a) {
          ...
          TouchEvent: function (a) {
            var b = document.createTouch(window, m, 0, j[0], j[1], k[0], k[1], l[0], l[1], 0, 0, 0, 0),
              c = document.createTouchList(b), d = document.createTouchList(b), e = document.createTouchList(b);
  ...
  var a = this, b = function (a, b, c) {
    ...
    var b = a.getBoundingClientRect(), c = document.body, d = document.documentElement,
      e = window.pageYOffset || d.scrollTop || c.scrollTop, f = window.pageXOffset || d.scrollLeft || c.scrollLeft,
      g = d.clientTop || c.clientTop || 0, h = d.clientLeft || c.clientLeft || 0, i = b.top + e - g, j = b.left + f - h;
    ...
    return a
  }(), i = 10, j = 10, k = h > -1 && 9 > h, l = 9 === h, m = function (a) {
  ...
  }, q = "katavorio-drag-scope", r = ["stop", "start", "drag", "drop", "over", "out", "beforeStart"], s = function () {
  }, t = function () {
    return !0
  }, u = function (a, b, c) {
  ...
  }, y = "input,textarea,select,button,option", z = function (a, b, c) {
    ...
    var k = [0, 0], l = null, n = null, o = [0, 0], q = !1, r = this.params.consumeStartEvent !== !1, s = this.el,
      u = this.params.clone, w = (this.params.scroll, b.multipleDrop !== !1), y = !1,
      D = b.ghostProxy === !0 ? B : b.ghostProxy && "function" == typeof b.ghostProxy ? b.ghostProxy : C,
      E = function (a) {
        return a.cloneNode(!0)
      }, H = b.snapThreshold, I = function (a, b, c, d, e) {
        var f = Math.floor(a[0] / b), g = b * f, h = g + b,
          i = Math.abs(a[0] - g) <= d ? g : Math.abs(h - a[0]) <= d ? h : a[0], j = Math.floor(a[1] / c), k = c * j,
          l = k + c, m = Math.abs(a[1] - k) <= e ? k : Math.abs(l - a[1]) <= e ? l : a[1];
        return [i, m]
      };
    this.posses = [], this.posseRoles = {}, this.toGrid = function (a) {
      if (null == this.params.grid) return a;
      var b = this.params.grid ? this.params.grid[0] / 2 : H ? H : i / 2,
        c = this.params.grid ? this.params.grid[1] / 2 : H ? H : j / 2;
      return I(a, this.params.grid[0], this.params.grid[1], b, c)
    }, this.snap = function (a, b) {
      if (null != s) {
        a = a || (this.params.grid ? this.params.grid[0] : i), b = b || (this.params.grid ? this.params.grid[1] : j);
        var c = this.params.getPosition(s), d = this.params.grid ? this.params.grid[0] / 2 : H,
          e = this.params.grid ? this.params.grid[1] / 2 : H;
        this.params.setPosition(s, I(c, a, b, d, e))
      }
    ...
    var J, K = function (a) {
      ...
      J = "function" == typeof a ? a : a ? function (a, b, c, d) {
        return K([Math.max(0, Math.min(c.w - d[0], a[0])), Math.max(0, Math.min(c.h - d[1], a[1]))])
      }.bind(this) : function (a) {
        return K(a)
      }
    }.bind(this);
    L("function" == typeof this.params.constrain ? this.params.constrain : this.params.constrain || this.params.containment), this.setConstrain = function (a) {
      L(a)
    };
    var M;
    ...
    this.downListener = function (a) {
      ...
      if (b && this.isEnabled() && this.canDrag()) {
        ...
        if (d) {
          if (u) if (s = this.el.cloneNode(!0), this.params.addClass(s, p.clonedDrag), s.setAttribute("id", null), s.style.position = "absolute", null != this.params.parent) {
            var e = this.params.getPosition(this.el);
            s.style.left = e[0] + "px", s.style.top = e[1] + "px", this.params.parent.appendChild(s)
          } else {
            var g = f(this.el);
            s.style.left = g.left + "px", s.style.top = g.top + "px", document.body.appendChild(s)
          } else s = this.el;
          r && x(a), k = m(a), this.params.bind(document, "mousemove", this.moveListener), this.params.bind(document, "mouseup", this.upListener), h.markSelection(this), h.markPosses(this), this.params.addClass(document.body, c.noSelect), V("beforeStart", {
            el: this.el,
            pos: l,
            e: a,
            drag: this
      ...
      if (k) {
        if (!q) {
          var b = V("start", {el: this.el, pos: l, e: a, drag: this});
          if (b !== !1) {
            if (!k) return;
            this.mark(!0), q = !0
          } else this.abort()
        ...
        if (k) {
          T.length = 0;
          var c = m(a), d = c[0] - k[0], e = c[1] - k[1], f = this.params.ignoreZoom ? 1 : h.getZoom();
          d /= f, e /= f, this.moveBy(d, e, a), h.updateSelection(d, e, this), h.updatePosses(d, e, this)
        }
      }
    ...
    var U = {start: [], drag: [], stop: [], over: [], out: [], beforeStart: [], revert: []};
    b.events.start && U.start.push(b.events.start), b.events.beforeStart && U.beforeStart.push(b.events.beforeStart), b.events.stop && U.stop.push(b.events.stop), b.events.drag && U.drag.push(b.events.drag), b.events.revert && U.revert.push(b.events.revert), this.on = function (a, b) {
      U[a] && U[a].push(b)
    }, this.off = function (a, b) {
      if (U[a]) {
        for (var c = [], d = 0; d < U[a].length; d++) U[a][d] !== b && c.push(U[a][d]);
        U[a] = c
      }
    };
    var V = function (a, b) {
      var c = null;
      if (U[a]) for (var d = 0; d < U[a].length; d++) try {
        var e = U[a][d](b);
        null != e && (c = e)
      } catch (f) {
      }
    ...
    this.notifyStart = function (a) {
      ...
      if (b || q) {
        var c = [], d = h.getSelection(), e = this.params.getPosition(s);
        if (d.length > 1) for (var f = 0; f < d.length; f++) {
          var g = this.params.getPosition(d[f].el);
          c.push([d[f].el, {left: g[0], top: g[1]}, d[f]])
        } else c.push([s, {left: e[0], top: e[1]}, this]);
        V("stop", {el: s, pos: W || e, finalPos: e, e: a, drag: this, selection: c})
      }
    }, this.mark = function (a) {
      l = this.params.getPosition(s), n = this.params.getPosition(s, !0), o = [n[0] - l[0], n[1] - l[1]], this.size = this.params.getSize(s), S = h.getMatchingDroppables(this), v(S, !0, !1, this), this.params.addClass(s, this.params.dragClass || c.drag);
      var b;
      b = this.params.getConstrainingRectangle ? this.params.getConstrainingRectangle(s) : this.params.getSize(s.parentNode), R = {
        w: b[0],
        h: b[1]
    ...
    this.unmark = function (a, d) {
      if (v(S, !1, !0, this), y && D(this.el) ? (W = [s.offsetLeft, s.offsetTop], this.el.parentNode.removeChild(s), s = this.el) : W = null, this.params.removeClass(s, this.params.dragClass || c.drag), S.length = 0, y = !1, !d) {
        T.length > 0 && W && b.setPosition(this.el, W), T.sort(G);
      ...
      T.length = 0;
      var e = this.toGrid([l[0] + a, l[1] + c]), f = J(e, s, R, this.size);
      if (D(this.el)) if (e[0] !== f[0] || e[1] !== f[1]) {
        if (!y) {
          var g = E(this.el);
          b.addClass(g, p.ghostProxy), this.el.parentNode.appendChild(g), s = g, y = !0
        }
        f = e
      } else y && (this.el.parentNode.removeChild(s), s = this.el, y = !1);
      var h = {x: f[0], y: f[1], w: this.size[0], h: this.size[1]}, i = {x: h.x + o[0], y: h.y + o[1], w: h.w, h: h.h},
        j = null;
      this.params.setPosition(s, f);
      for (var k = 0; k < S.length; k++) {
        var m = {x: S[k].pagePosition[0], y: S[k].pagePosition[1], w: S[k].size[0], h: S[k].size[1]};
        this.params.intersects(i, m) && (w || null == j || j === S[k].el) && S[k].canDrop(this) ? (j || (j = S[k].el), T.push(S[k]), S[k].setHover(this, !0, d)) : S[k].isHover() && S[k].setHover(this, !1, d)
      }
  ...
  a.Katavorio = function (a) {
    ...
    }.bind(this), m = {}, n = a.css || {}, o = a.scope || q;
    ...
    var C = {}, F = function (a, c, d) {
      var f = e(c) ? c : c.id, g = e(c) ? !0 : c.active !== !1, h = C[f] || function () {
    ...
    this.addToPosse = function (a, b) {
      for (var c = [], d = 1; d < arguments.length; d++) c.push(F(a, arguments[d]));
      return 1 === c.length ? c[0] : c
    }, this.setPosse = function (a, b) {
      for (var c = [], e = 1; e < arguments.length; e++) c.push(F(a, arguments[e], !0).name);
      return w(a, function (a) {
        if (a._katavorioDrag) {
  ...
  }, a.Katavorio.version = "0.27.0", "undefined" != typeof exports && (exports.Katavorio = a.Katavorio)
}.call("undefined" != typeof window ? window : this), function () {
  "use strict";
  ...
  var m = 0, n = function () {
    ...
    this.version = "2.7.15", this.Defaults = {
      Anchor: "Bottom",
      Anchors: [null, null],
    ...
    this.unbindContainer = function () {
      ...
      var b = q;
      q = a, r.length = 0;
      for (var c = {endpointclick: "endpointClick", endpointdblclick: "endpointDblClick"}, d = function (a, b, d) {
      ...
      F = this.Defaults.Scope, G = 1, H = function () {
        ...
        if (!p.headless) {
          ...
          if (h && p.isDragSupported(a, f)) {
            ...
            if (i = p.extend({}, i), p.isAlreadyDraggable(a, f)) d.force && f.initDraggable(a, i); else {
              var j = p.dragEvents.drag, k = p.dragEvents.stop, l = p.dragEvents.start, m = !1;
              ...
              A[n] = !0;
              var o = A[n];
              i.disabled = null == o ? !1 : !o, f.initDraggable(a, i), f.getDragManager().register(a), g && f.fire("elementDraggable", {
                el: a,
                options: i
              })
            }
        ...
        if (!d.type && d.sourceEndpoint && (d.type = d.sourceEndpoint.connectionType), d.sourceEndpoint && d.sourceEndpoint.connectorOverlays) {
          ...
          for (var e = 0, g = d.sourceEndpoint.connectorOverlays.length; g > e; e++) d.overlays.push(d.sourceEndpoint.connectorOverlays[e])
        }
        ...
        var e = new c(d);
        return e.id = "ep_" + H(), sa(d.elementId, d.source), p.headless || f.getDragManager().endpointAdded(d.source, b), e
      }, S = function (a, b, c) {
        var d = v[a];
    ...
    this.setConnectionBeingDragged = function (a) {
      ...
      for (var g = [], h = b.isArray(a) || null != a.length && !b.isString(a) ? a : [a], i = 0, j = h.length; j > i; i++) {
        ...
        var k = Y(e.source), l = R(e, k), m = sa(k, e.source).info.o;
    ...
    var ba = "isDetachAllowed", ca = "beforeDetach", da = "checkCondition";
    this.deleteConnection = function (a, c) {
      ...
      var c = Y(a), d = v[c];
      if (d && d.length) for (var e = 0, g = d.length; g > e; e++) d[e].deleteEveryConnection(b);
      return f
    }, this.deleteObject = function (a) {
      var c = {endpoints: {}, connections: {}, endpointCount: 0, connectionCount: 0},
        d = a.deleteAttachedObjects !== !1, e = function (b) {
    ...
    var ea = function (a, b, c, d) {
      ...
      if (a) if ("string" == typeof a) {
        if ("*" === a) return a;
        c.push(a)
      } else if (b) c = a; else if (a.length) for (var d = 0, e = a.length; e > d; d++) c.push(m(a[d]).id); else c.push(m(a).id);
      return c
    }, ja = function (a, b, c) {
    ...
    this.getConnections = function (a, b) {
      ...
      for (var c = a.scope || f.getDefaultScope(), d = ia(c, !0), e = ia(a.source), g = ia(a.target), h = !b && d.length > 1 ? {} : [], i = function (a, c) {
        if (!b && d.length > 1) {
          var e = h[a];
    ...
    var ka = function (a, b) {
      ...
      var c, d, e = {length: a.length, each: ka(a, b), get: la(a)},
    ...
    this.select = function (a) {
      ...
      a = a || {}, a.scope = a.scope || "*";
      var b = !a.element && !a.source && !a.target, c = b ? "*" : ia(a.element), d = b ? "*" : ia(a.source),
        e = b ? "*" : ia(a.target), f = ia(a.scope, !0), g = [];
      for (var h in v) {
        var i = ja(c, h, !0), j = ja(d, h, !0), k = "*" !== d, l = ja(e, h, !0), m = "*" !== e;
    ...
    var qa = function (a) {
      ...
      return x[a] || (x[a] = {el: b, endpoints: [], connections: []}, x[a].info = ta({
        elId: a,
        timestamp: E
    ...
    this.makeTarget = function (b, c, d) {
      ...
      for (var g = e.maxConnections || -1, h = function (b) {
        var c = m(b), d = c.id, h = a.jsPlumb.extend({}, e.dropOptions || {}), i = e.connectionType || "default";
        this.targetEndpointDefinitions[d] = this.targetEndpointDefinitions[d] || {}, qa(d), c.el._isJsPlumbGroup && null == h.rank && (h.rank = -1);
        var j = {def: a.jsPlumb.extend({}, e), uniqueEndpoint: e.uniqueEndpoint, maxConnections: g, enabled: !0};
        e.createEndpoint && (j.uniqueEndpoint = !0, j.endpoint = f.addEndpoint(b, j.def), j.endpoint.setDeleteOnEmpty(!1)), c.def = j, this.targetEndpointDefinitions[d][i] = j, va(c, e, h, e.isSource === !0, !0), c.el._katavorioDrop[c.el._katavorioDrop.length - 1].targetDef = j
      ...
      for (var j = g.maxConnections || -1, k = g.onMaxConnections, n = function (d) {
        ...
        var m = {def: a.jsPlumb.extend({}, g), uniqueEndpoint: g.uniqueEndpoint, maxConnections: j, enabled: !0};
        ...
        var n = a.jsPlumb.dragEvents.stop, o = a.jsPlumb.dragEvents.drag, p = a.jsPlumb.extend({}, g.dragOptions || {}),
          q = p.drag, r = p.stop, s = null, t = !1;
        p.scope = p.scope || g.scope, p[o] = b.wrap(p[o], function () {
          ...
          if (r && r.apply(this, arguments), this.currentlyDragging = !1, null != s._jsPlumb) {
            ...
            if (null != d.positionFinder) {
              var i = f.getOffset(h), j = this.getSize(h), k = {left: i.left + b.x * j[0], top: i.top + b.y * j[1]},
        ...
        var u = function (c) {
          if (3 !== c.which && 2 !== c.button) {
            ...
            if (m.enabled) {
              ...
              var q = a.jsPlumb.getPositionOnElement(c, i, l), r = {};
              a.jsPlumb.extend(r, g), r.isTemporarySource = !0, r.anchor = [q[0], q[1], 0, 0], r.dragOptions = p, m.def.scope && (r.scope = m.def.scope), s = this.addEndpoint(e, r), t = !0, s.setDeleteOnEmpty(!0), m.uniqueEndpoint && (m.endpoint ? s.finalEndpoint = m.endpoint : (m.endpoint = s, s.setDeleteOnEmpty(!1)));
              var u = function () {
                f.off(s.canvas, "mouseup", u), f.off(d.el, "mouseup", u), t && (t = !1, f.deleteEndpoint(s))
              };
              f.on(s.canvas, "mouseup", u), f.on(d.el, "mouseup", u);
              var v = {};
              if (m.def.extract) for (var w in m.def.extract) {
    ...
    var ya = function (a, c, d, e, g) {
      ...
      if (g = g || "default", c.length && !b.isString(c)) {
        h = [];
        for (var l = 0, n = c.length; n > l; l++) i = m(c[l]), k[i.id] && k[i.id][g] && (h[l] = k[i.id][g].enabled, j = e ? !h[l] : d, k[i.id][g].enabled = j, f[j ? "removeClass" : "addClass"](i.el, "jtk-" + a + "-disabled"))
      } else {
        i = m(c);
        var o = i.id;
    ...
    this.repaint = function (a, b, c) {
      ...
      var d = function (a) {
        ...
        if (delete v[h.id], b && h.el && 3 !== h.el.nodeType && 8 !== h.el.nodeType) for (e = 0, g = h.el.childNodes.length; g > e; e++) d(h.el.childNodes[e])
      };
      return d(a), this
    };
    var Ba = function (a, b) {
    ...
    this.clear = function () {
      ...
      var f = this.getConnections({source: e, scope: "*"}, !0), g = this.getConnections({target: e, scope: "*"}, !0);
    ...
    this.register = function (g) {
      ...
      if (null != b) {
        ...
        if (i) for (var j in i) if (i.hasOwnProperty(j)) {
          ...
          e || (e = a.getOffset(g)), d[h][j] = {id: j, offset: {left: l.left - e.left, top: l.top - e.top}}, f[j] = h
        }
      }
      ...
      i && d[i] && delete d[i][c], d[g][c] = {id: c, offset: {left: k.left - j.left, top: k.top - j.top}}, f[c] = g
  ...
  a.jsPlumb.extend(a.jsPlumbInstance.prototype, {
    ...
    getPositionOnElement: function (a, b, c) {
      var d = "undefined" != typeof b.getBoundingClientRect ? b.getBoundingClientRect() : {
        ...
        j = f.clientLeft || e.clientLeft || 0, k = 0, l = 0, m = d.top + g - i + k * c, n = d.left + h - j + l * c,
        o = jsPlumb.pageLocation(a), p = d.width || b.offsetWidth * c, q = d.height || b.offsetHeight * c,
        r = (o[0] - n) / p, s = (o[1] - m) / q;
      return [r, s]
    },
  ...
  var a = this, b = a.jsPlumb, c = a.jsPlumbUtil, d = function (a, b, c) {
      ...
      var j = new b.FloatingAnchor({reference: c, referenceCanvas: e, jsPlumbInstance: g});
  ...
  b.Endpoint = function (a) {
    ...
    var l = null;
    this._jsPlumb.uuid && (a.endpointsByUUID[this._jsPlumb.uuid] = this), this.elementId = a.elementId,
      this.dragProxy = a.dragProxy, this._jsPlumb.connectionCost = a.connectionCost, this._jsPlumb.connectionsDirected = a.connectionsDirected, this._jsPlumb.currentAnchorClass = "", this._jsPlumb.events = {};
    ...
    this.initDraggable = function () {
      if (!p && b.isDragSupported(this.element)) {
        var g, h = {id: null, element: null}, m = null, n = !1, o = null, q = d(this, h, i), r = a.dragOptions || {},
          s = {}, t = b.dragEvents.start, u = b.dragEvents.stop, v = b.dragEvents.drag, w = b.dragEvents.beforeStart,
          x = function (a) {
            g = a.e.payload || {}
          }, y = function (c) {
    ...
    var t = function (d, e, f, g) {
      if (b.isDropSupported(this.element)) {
        ...
        h[j] = c.wrap(h[j], n, !0), h[k] = c.wrap(h[k], function () {
          ...
          var a = b.getDragObject(arguments), c = null == a ? null : i.getAttribute(b.getElement(a), "dragId"),
  ...
  b.Connection = function (a) {
    ...
    if (!e.isSuspendDrawing()) {
      var k = e.getCachedData(this.sourceId), l = k.o, m = k.s, n = e.getCachedData(this.targetId), o = n.o, p = n.s,
        q = j || e.timestamp(), r = this.endpoints[0].anchor.compute({
          xy: [l.left, l.top],
          wh: m,
    ...
    applyType: function (a, c, d) {
      ...
      if (!this._jsPlumb.instance.isSuspendDrawing() && this._jsPlumb.visible) {
        a = a || {};
        var b = a.timestamp, c = !1, d = c ? this.sourceId : this.targetId, e = c ? this.targetId : this.sourceId,
          f = c ? 0 : 1, g = c ? 1 : 0;
        if (null == b || b !== this._jsPlumb.lastPaintedAt) {
          var h = this._jsPlumb.instance.updateOffset({elId: e}).o,
            i = this._jsPlumb.instance.updateOffset({elId: d}).o, j = this.endpoints[g], k = this.endpoints[f],
      ...
      if (f) d.endpoints[g] = f, f.addConnection(d); else {
        ...
        }), null == f && k.setDeleteOnEmpty(!0), d.endpoints[g] = k, h.drawEndpoints === !1 && k.setVisible(!1, !0, !0)
      }
      return k
    }
  })
  ...
  c.AnchorManager = function (a) {
    ...
    this.updateOtherEndpoint = function (a, d, e, f) {
      ...
      if (!k.isSuspendDrawing()) {
        ...
        f = f || k.timestamp(), g = g || {left: 0, top: 0}, e && (e = {left: e.left + g.left, top: e.top + g.top});
        for (var u = k.updateOffset({elId: a, offset: e, recalc: !1, timestamp: f}), v = {}, w = 0; w < o.length; w++) {
          ...
          if (A || B) {
            ...
            A && !j[y] && (j[y] = {top: [], right: [], bottom: [], left: []}), B && !j[z] && (j[z] = {
              top: [],
              right: [],
              bottom: [],
              left: []
            }), a !== z && k.updateOffset({elId: z, timestamp: f}), a !== y && k.updateOffset({elId: y, timestamp: f});
        ...
        for (w = 0; w < n.length; w++) n[w].paint({timestamp: f, offset: u, dimensions: u.s, recalc: m !== !0});
  ...
  c.Anchors.Continuous = function (a) {
    ...
    Fixed: function (a, b, c) {
      ...
      var e = a.left - b.left, f = a.top - b.top, g = c[0] / d.grid[0], h = c[1] / d.grid[1], i = Math.floor(e / g),
        j = Math.floor(f / h);
  ...
  b.Segments = {
    AbstractSegment: function (a) {
      ...
      this.type = "Straight", this.getLength = function () {
        ...
        var e = this.pointOnPath(a, c), f = 0 >= b ? {x: g, y: i} : {x: h, y: j};
      ...
      this.pointOnPath = function (b, c) {
        ...
        var e = this.pointOnPath(b, d), f = c / h * 2 * Math.PI, g = this.anticlockwise ? -1 : 1, i = e.theta + g * f,
          j = a.cx + this.radius * Math.cos(i), k = a.cy + this.radius * Math.sin(i);
        return {x: j, y: k}
      }
    }, Bezier: function (c) {
  ...
  b.Connectors.AbstractConnector = function (a) {
    ...
    a = a || {}, this.width = a.width || 20, this.height = a.height || 20, this._compute = function (a, b, c, d) {
      var e = c.width || this.width, f = c.height || this.height, g = a[0] - e / 2, h = a[1] - f / 2;
      return [g, h, e, f]
    }
  ...
  c.extend(f, b.jsPlumbUIComponent, {
    ...
    a = a || {}, a.width = a.width || 55, a.height = a.height || 55, this.width = a.width, this.height = a.height, this._compute = function (a, b, d, e) {
      var f = d.width || c.width, g = d.height || c.height, h = a[0] - f / 2, i = a[1] - g / 2;
      return [h, i, f, g]
    }
  };
  ...
  c.extend(i, [b.jsPlumbUIComponent, g], {
    ...
    a.length = 50, a.strokeWidth = 5, this.type = "GuideLines", g.apply(this, arguments), b.jsPlumbUIComponent.apply(this, arguments), this.draw = function (b, c) {
      var e = b.pointAlongPathFrom(a.loc, a.length / 2), f = b.pointOnPath(a.loc), g = d.pointOnLine(e, f, a.length),
        h = d.perpendicularLineTo(e, g, 40), i = d.perpendicularLineTo(g, e, 20);
      return {
        connector: b,
        head: e,
        tail: g,
  ...
  var a = this, b = a.jsPlumbUtil, c = a.jsPlumbInstance, d = "jtk-group-collapsed", e = "jtk-group-expanded",
    ...
    u = "internal.connectionDetached", v = "removeAll", w = "orphanAll", x = "show", y = "hide", z = function (a) {
      ...
      var v = this.getDragArea = function () {
        ...
        }, w = d.ghost === !0, x = w || d.constrain === !0, y = d.revert !== !1, z = d.orphan === !0, A = d.prune === !0,
        B = d.dropOverride === !0, C = d.proxied !== !1, D = [];
  ...
  var a = this, b = a.jsPlumb, c = a.jsPlumbUtil, d = "Straight", e = "Arc", f = function (a) {
    ...
    var c, f, g = b.Connectors.AbstractConnector.apply(this, arguments), h = null == a.midpoint ? .5 : a.midpoint,
      i = a.alwaysRespectStubs === !0, j = null, k = null, l = null != a.cornerRadius ? a.cornerRadius : 0,
        ...
        for (var f, h, i, j = null, k = 0; k < b.length - 1; k++) {
          if (j = j || q(b[k]), f = q(b[k + 1]), h = n(j), i = n(f), l > 0 && j[4] !== f[4]) {
            ...
            var r = h[1] === i[0] && 1 === i[0] || h[1] === i[0] && 0 === i[0] && h[0] !== i[1] || h[1] === i[0] && -1 === i[0],
              s = f[1] > j[3] ? 1 : -1, t = f[0] > j[2] ? 1 : -1, u = s === t, v = u && r || !u && !r ? f[0] : j[2],
              w = u && r || !u && !r ? j[3] : f[1];
    ...
    this._compute = function (a, b) {
      ...
      var d = function () {
        ...
        }, l = e[a.anchorOrientation](a.sourceAxis), m = "x" === a.sourceAxis ? 0 : 1, n = "x" === a.sourceAxis ? 1 : 0,
        p = l[m], q = l[n], s = l[m + 2], t = l[n + 2];
      o(c, l[0], l[1], a);
  ...
  b.Connectors.AbstractBezierConnector = function (a) {
    a = a || {};
    var c, d = a.showLoopback !== !1, e = (a.curviness || 10, a.margin || 5),
      f = (a.proximityLimit || 80, a.orientation && "clockwise" === a.orientation), g = a.loopbackRadius || 25, h = !1;
  ...
  var d = function (a) {
    ...
    this.getCurviness = function () {
      ...
      var h, i, j = d[0] < e[0] ? f : 0, k = d[1] < e[1] ? g : 0, l = d[0] < e[0] ? 0 : f, m = d[1] < e[1] ? 0 : g;
  ...
  var a = this, b = a.jsPlumb, c = a.jsPlumbUtil, d = function (a, b, c, d) {
    ...
    var c, f = b.Connectors.AbstractBezierConnector.apply(this, arguments), g = a.curviness || 10, h = a.margin || 5,
  ...
  var a = this, b = a.jsPlumb, c = a.jsPlumbUtil, d = {
    ...
    k = "stop", l = "stroke", m = "stroke-width", n = "style", o = "none", p = "jsplumb_gradient_", q = "strokeWidth",
    r = {svg: "http://www.w3.org/2000/svg"}, s = function (a, b) {
      ...
      for (var o = 0; o < c.gradient.stops.length; o++) {
        var q = 1 === e.segment || 2 === e.segment ? o : c.gradient.stops.length - 1 - o, r = c.gradient.stops[q][1],
  ...
  var B = function (a, c) {
    ...
    this.path = null, this.paint = function (a, b) {
      if (a.component.svg && b) {
        null == this.path && (this.path = t("path", {"pointer-events": "all"}), a.component.svg.appendChild(this.path), this.elementCreated && this.elementCreated(this.path, a.component),
