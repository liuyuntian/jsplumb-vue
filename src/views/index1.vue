<template>
    <div id="drawDiv" style="height: 100%; display: flex; justify-content: flex-end">
        ...
        <oui-include type="module" url="/res_engine/flow_graph_1/jsplumbContent.vue.html" data="myData"></oui-include>
        <div class="bottom-menu">
            <el-button type="primary" @click="saveChange">保 存</el-button>
            <el-button @click="cancelChange">刷 新</el-button>
        </div>
        <el-dialog
                title="关联设置"
                ...
                myData:
                    {
                        data: {
                            ...
                            lineIds: [
                                "414353914314358784_433571469698032107"
                            ],
                            rootIds: [
                                "414353914314358784"
                            ],
                            ...
                            lineMap: {
                                414353914314358784_433571469698032107: {
                                    id: "414353914314358784_433571469698032107",
                                    fromId: "414353914314358784",
                                    toId: "433571469698032107",
                                    lineType: "",
                                    name: ""
                                }
                            }
